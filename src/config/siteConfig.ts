...
export const siteConfig: SiteConfig = {
  firmName: 'Conozca',
  firmSlogan: 'Cultura, Negocios y Diseño',
  firmDescription: 'Revista digital con historias pensadas, claras y creadas para enfocarse. Conozca cura cultura, negocios y diseño con una experiencia de lectura tranquila y un sistema editorial moderno.',
  ...
  seo: {
    siteTitle: 'Conozca, la voz del SEC en america latina',
    titleTemplate: '%s | Conozca',
    defaultDescription: 'Revista digital con historias pensadas, claras y creadas para enfocarse. Conozca cura cultura, negocios y diseño.',
    locale: 'es_AR',
  },
