...
const INITIAL_MESSAGE: Message = {
  id: '1',
  type: 'bot',
  content: 'Hola, soy el asistente editorial de Conozca. Estoy aquí para ayudarte con tus publicaciones y consultas académicas.',
  timestamp: new Date(),
  quickReplies: ['Publicar artículo', 'Ver categorías', 'Guía de estilo']
}

const FAQ_RESPONSES: Record<string, string> = {
  'guía de estilo': 'Nuestra guía de estilo requiere fuentes académicas, interlineado de 1.5 y sangría en la primera línea. ¿Te gustaría saber más?',
  'ver categorías': 'Nuestras categorías principales son: Bíblicos, Ministeriales y Teología. ¿En cuál deseas publicar?',
  'publicar artículo': 'Para publicar, ve a tu panel de autor y haz clic en "Nuevo Artículo". Puedes importar archivos docx y pdf directamente.',
  'contacto': 'Puedes contactar a la redacción en editorial@conozca.com.',
}
    ...
    <Card className="fixed bottom-6 right-6 w-[380px] h-[600px] flex flex-col shadow-2xl z-50 animate-scale-in overflow-hidden">
      ...
      <div className="bg-gray-900 border-b border-gray-800">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h3 className="font-semibold">Conozca Asistente</h3>
          ...
          <div className="flex items-start gap-2">
            ...
            <div className="flex-1">
              <p className="text-xs text-warning-800">
                <strong>Aviso Legal:</strong> Este asistente editorial no reemplaza la revisión de pares ni la labor del editor jefe.
              </p>
              <button
