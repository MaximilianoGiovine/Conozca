          ...
          <div className="space-y-6">
            <div className="bg-white rounded-xl p-6 shadow-card border border-gray-100">
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="font-heading font-semibold text-gray-900 mb-1">{t('officeLocation')}</h3>
            ...
            <div className="bg-white rounded-xl p-6 shadow-card border border-gray-100">
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="font-heading font-semibold text-gray-900 mb-1">{t('contactDetails')}</h3>
                  <p className="text-body-sm text-foreground-secondary">
                    {t('callAt')} <a href={`tel:${contact.phone}`} className="text-teal-600 hover:underline">{contact.phoneDisplay}</a> {t('orEmail')}{' '}
            ...
            <div className="bg-white rounded-xl p-6 shadow-card border border-gray-100">
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="font-heading font-semibold text-gray-900 mb-1">{t('officeHours')}</h3>
