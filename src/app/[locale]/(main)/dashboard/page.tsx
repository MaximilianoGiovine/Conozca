...
export default async function DashboardPage() {
  ...
  if (['superadmin', 'admin', 'author'].includes(userRole)) {
    redirect('/admin-dashboard')
  }

  // Fallback to profiles table for legacy roles or general users
