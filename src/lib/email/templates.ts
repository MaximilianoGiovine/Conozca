// Email templates for Conozca Digital Magazine
...
const baseStyles = `
  ...
  .header { background: linear-gradient(135deg, #1a1008 0%, #2d1f0a 100%); padding: 32px; text-align: center; }
  .header h1 { color: #f59e0b; margin: 0; font-size: 28px; font-weight: 700; font-family: 'Playfair Display', serif; }
  .header p { color: rgba(245,158,11,0.8); margin: 8px 0 0; font-size: 14px; }
  .content { padding: 32px; }
  .greeting { font-size: 18px; color: #1f2937; margin-bottom: 16px; }
  .message { color: #4b5563; line-height: 1.6; margin-bottom: 24px; }
  .details-card { background-color: #fffbeb; border-radius: 12px; padding: 24px; margin-bottom: 24px; }
  .details-card h3 { color: #92400e; margin: 0 0 16px; font-size: 16px; text-transform: uppercase; letter-spacing: 0.5px; }
...
<head>
  ...
  <title>Cita Confirmada - Conozca</title>
...
<body>
  <div class="container">
    ...
    <div class="footer">
      <p>Este correo fue enviado autom&aacute;ticamente por Conozca</p>
      <p>&copy; ${new Date().getFullYear()} Conozca - Gesti&oacute;n Legal Inteligente</p>
    </div>
  </div>
</body>
</html>
...
<head>
  <meta charset="utf-8">
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
  <title>Nueva Cita Agendada - Conozca</title>
  <style>${baseStyles}</style>
</head>
<body>
  <div class="container">
...
<head>
  <meta charset="utf-8">
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
  <title>Nueva Cita en el Sistema - Conozca</title>
  <style>${baseStyles}</style>
</head>
<body>
  <div class="container">
    ...
    <div class="content">
      ...
      <p class="message">
        Se ha registrado una nueva cita en el sistema Conozca.
      </p>
    ...
    <div class="footer">
      <p>Notificaci&oacute;n autom&aacute;tica del sistema Conozca</p>
      <p>&copy; ${new Date().getFullYear()} Conozca</p>
    </div>
  </div>
</body>
</html>
...
<head>
  <meta charset="utf-8">
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
  <title>Cita ${config.label} - Conozca</title>
  <style>${baseStyles}</style>
</head>
<body>
  <div class="container">
